...
import org.mule.module.kindling.processors.CreateIdeaMessageProcessor;
...
public class CreateIdeaDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(CreateIdeaDefinitionParser.class);

    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(CreateIdeaMessageProcessor.class.getName());
            ...
            logger.error(("Cannot launch the mule app, the @Processor [create-idea] within the connector [kindling] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the @Processor [create-idea] within the connector [kindling] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }

    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = getBeanDefinitionBuilder(parserContext);
        builder.addConstructorArgValue("createIdea");
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        if (!hasAttribute(element, "config-ref")) {
            throw new BeanDefinitionParsingException(new Problem("It seems that the config-ref for @Processor [create-idea] within the connector [kindling] is null or missing. Please, fill the value with the correct global element.", new Location(parserContext.getReaderContext().getResource()), null));
        }
        parseConfigRef(element, builder);
        if (!parseObjectRef(element, builder, "idea", "idea")) {
            BeanDefinitionBuilder ideaBuilder = BeanDefinitionBuilder.rootBeanDefinition(KindlingIdeaExpressionHolder.class.getName());
            Element ideaChildElement = DomUtils.getChildElementByTagName(element, "idea");
            if (ideaChildElement!= null) {
                parseProperty(ideaBuilder, ideaChildElement, "className", "className");
                parseProperty(ideaBuilder, ideaChildElement, "id", "id");
                if (!parseObjectRef(ideaChildElement, ideaBuilder, "category", "category")) {
                    ...
                    Element _categoryChildElement = DomUtils.getChildElementByTagName(ideaChildElement, "category");
                    if (_categoryChildElement!= null) {
                        ...
                        ideaBuilder.addPropertyValue("category", _categoryBuilder.getBeanDefinition());
                    }
                }
                parseProperty(ideaBuilder, ideaChildElement, "title", "title");
                parseProperty(ideaBuilder, ideaChildElement, "description", "description");
                parseProperty(ideaBuilder, ideaChildElement, "votes", "votes");
                parseProperty(ideaBuilder, ideaChildElement, "anonymous", "anonymous");
                parseProperty(ideaBuilder, ideaChildElement, "dateCreated", "dateCreated");
                parseProperty(ideaBuilder, ideaChildElement, "dateCreatedLocalized", "dateCreatedLocalized");
                parseProperty(ideaBuilder, ideaChildElement, "dateUpdated", "dateUpdated");
                parseProperty(ideaBuilder, ideaChildElement, "dateUpdatedLocalized", "dateUpdatedLocalized");
                parseProperty(ideaBuilder, ideaChildElement, "dateManaged", "dateManaged");
                parseProperty(ideaBuilder, ideaChildElement, "dateManagedLocalized", "dateManagedLocalized");
                parseProperty(ideaBuilder, ideaChildElement, "dateRectified", "dateRectified");
                parseProperty(ideaBuilder, ideaChildElement, "dateRectifiedLocalized", "dateRectifiedLocalized");
                parseProperty(ideaBuilder, ideaChildElement, "stateId", "stateId");
                parseProperty(ideaBuilder, ideaChildElement, "stateName", "stateName");
                parseProperty(ideaBuilder, ideaChildElement, "cachetags", "cachetags");
                parseProperty(ideaBuilder, ideaChildElement, "lockedForComments", "lockedForComments");
                parseProperty(ideaBuilder, ideaChildElement, "bonfireUrl", "bonfireUrl");
                parseProperty(ideaBuilder, ideaChildElement, "submissionSource", "submissionSource");
                parseProperty(ideaBuilder, ideaChildElement, "resourceUri", "resourceUri");
                parseProperty(ideaBuilder, ideaChildElement, "applicationUri", "applicationUri");
                parseProperty(ideaBuilder, ideaChildElement, "assignedTo", "assignedTo");
                if (!parseObjectRef(ideaChildElement, ideaBuilder, "author", "author")) {
                    BeanDefinitionBuilder _authorBuilder = BeanDefinitionBuilder.rootBeanDefinition(KindlingUserExpressionHolder.class.getName());
                    Element _authorChildElement = DomUtils.getChildElementByTagName(ideaChildElement, "author");
                    if (_authorChildElement!= null) {
                        parseProperty(_authorBuilder, _authorChildElement, "className", "className");
                        parseProperty(_authorBuilder, _authorChildElement, "id", "id");
                        if (hasAttribute(_authorChildElement, "avatar-ref")) {
                            if (_authorChildElement.getAttribute("avatar-ref").startsWith("#")) {
                                _authorBuilder.addPropertyValue("avatar", _authorChildElement.getAttribute("avatar-ref"));
                            } else {
                                _authorBuilder.addPropertyValue("avatar", (("#[registry:"+ _authorChildElement.getAttribute("avatar-ref"))+"]"));
                            }
                        }
                        parseProperty(_authorBuilder, _authorChildElement, "username", "username");
                        parseProperty(_authorBuilder, _authorChildElement, "firstName", "firstName");
                        parseProperty(_authorBuilder, _authorChildElement, "lastName", "lastName");
                        parseProperty(_authorBuilder, _authorChildElement, "email", "email");
                        if (!parseObjectRef(_authorChildElement, _authorBuilder, "email-preferences", "emailPreferences")) {
                            ...
                            Element __emailPreferencesChildElement = DomUtils.getChildElementByTagName(_authorChildElement, "email-preferences");
                            if (__emailPreferencesChildElement!= null) {
                                ...
                                _authorBuilder.addPropertyValue("emailPreferences", __emailPreferencesBuilder.getBeanDefinition());
                            }
                        }
                        parseProperty(_authorBuilder, _authorChildElement, "votesTotal", "votesTotal");
                        parseProperty(_authorBuilder, _authorChildElement, "reputation", "reputation");
                        parseProperty(_authorBuilder, _authorChildElement, "stateId", "stateId");
                        parseProperty(_authorBuilder, _authorChildElement, "stateName", "stateName");
                        parseProperty(_authorBuilder, _authorChildElement, "resetRequested", "resetRequested");
                        parseProperty(_authorBuilder, _authorChildElement, "storNotification", "storNotification");
                        parseProperty(_authorBuilder, _authorChildElement, "backend", "backend");
                        parseProperty(_authorBuilder, _authorChildElement, "fullName", "fullName");
                        parseProperty(_authorBuilder, _authorChildElement, "avatarUri", "avatarUri");
                        parseProperty(_authorBuilder, _authorChildElement, "resourceUri", "resourceUri");
                        parseProperty(_authorBuilder, _authorChildElement, "applicationUri", "applicationUri");
                        parseProperty(_authorBuilder, _authorChildElement, "locale", "locale");
                        parseProperty(_authorBuilder, _authorChildElement, "lastLogin", "lastLogin");
                        parseProperty(_authorBuilder, _authorChildElement, "lastLoginLocalized", "lastLoginLocalized");
                        parseProperty(_authorBuilder, _authorChildElement, "dateCreated", "dateCreated");
                        parseProperty(_authorBuilder, _authorChildElement, "dateCreatedLocalized", "dateCreatedLocalized");
                        parseListAndSetProperty(_authorChildElement, _authorBuilder, "skills", "skills", "skill", new ParseDelegate<String>() {
                        ...
                        parseListAndSetProperty(_authorChildElement, _authorBuilder, "interests", "interests", "interest", new ParseDelegate<String>() {
                        ...
                        parseListAndSetProperty(_authorChildElement, _authorBuilder, "categories", "categories", "category", new ParseDelegate<BeanDefinition>() {
                        ...
                        parseProperty(_authorBuilder, _authorChildElement, "isAnonymous", "isAnonymous");
                        parseProperty(_authorBuilder, _authorChildElement, "token", "token");
                        ideaBuilder.addPropertyValue("author", _authorBuilder.getBeanDefinition());
                    }
                }
                parseListAndSetProperty(ideaChildElement, ideaBuilder, "tags", "tags", "tag", new ParseDelegate<String>() {
                ...
                parseListAndSetProperty(ideaChildElement, ideaBuilder, "comments", "comments", "comment", new ParseDelegate<BeanDefinition>() {
                ...
                if (!parseObjectRef(ideaChildElement, ideaBuilder, "current-user-info", "currentUserInfo")) {
                    BeanDefinitionBuilder _currentUserInfoBuilder = BeanDefinitionBuilder.rootBeanDefinition(KindlingIdeaCurrentUserInfoExpressionHolder.class.getName());
                    Element _currentUserInfoChildElement = DomUtils.getChildElementByTagName(ideaChildElement, "current-user-info");
                    if (_currentUserInfoChildElement!= null) {
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "votes", "votes");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "votesAvailable", "votesAvailable");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "votesMax", "votesMax");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "votesTotal", "votesTotal");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "voterCount", "voterCount");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "ideaId", "ideaId");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "categoryId", "categoryId");
                        parseProperty(_currentUserInfoBuilder, _currentUserInfoChildElement, "isVotable", "isVotable");
                        ideaBuilder.addPropertyValue("currentUserInfo", _currentUserInfoBuilder.getBeanDefinition());
                    }
                }
                if (hasAttribute(ideaChildElement, "events-ref")) {
                    if (ideaChildElement.getAttribute("events-ref").startsWith("#")) {
                        ideaBuilder.addPropertyValue("events", ideaChildElement.getAttribute("events-ref"));
                    } else {
                        ideaBuilder.addPropertyValue("events", (("#[registry:"+ ideaChildElement.getAttribute("events-ref"))+"]"));
                    }
                }
                parseListAndSetProperty(ideaChildElement, ideaBuilder, "volunteers", "volunteers", "volunteer", new ParseDelegate<String>() {
                ...
                parseListAndSetProperty(ideaChildElement, ideaBuilder, "contributors", "contributors", "contributor", new ParseDelegate<String>() {
                ...
                builder.addPropertyValue("idea", ideaBuilder.getBeanDefinition());
            }
        }
